...
class ClearNest:
    ...
    def build_ui(self):
        ...
        ttk.Button(action_frame, text="🗂️ Ver en carpeta", command=self.open_in_explorer).pack()

        tk.Label(self.root, text="Estado del análisis:", font=("Segoe UI", 11, "bold")).pack(pady=(5, 0))
